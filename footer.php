...
class footer	{
	public $menu = array("Home", "Create Category", "Upload", "Delete", "About", "GPA");	
	public $links = array("Home"=>"/", "Create Category"=>"/insToSubView.php", "Upload"=>"/uploadView.php", "Delete"=>"/delView.php", "About"=>"/about.php", "GPA"=>"/gpaini.php");
